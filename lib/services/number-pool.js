...
exports.NP_CACHE_KEY = undefined;
...
var NP_CACHE_KEY = exports.NP_CACHE_KEY = 'NumberPool.available_numbers';
    ...
    return {
      ...
      clearCache: function clearCache() {
        return _rx.Observable.create(function (observer) {
          var cache = env.cache || _cache;
          var willRemove = cache.has(NP_CACHE_KEY);
